...
jQuery.fn.ytplaylist = function(options) {
  ...
  return this.each(function() {
		...
		$el.children('li').each(function() {
            $(this).find('a').each(function() {
                ...
                if (thisHref.startsWith('http://www.youtube.com')) {
                    $(this).addClass('yt-vid').parent().append('<span class="vid-play"/>');
		...
		$el.find(".vid-play").click(function () {
		    $(this).parent('li').find('a.yt-vid').click();
		})
		...
		$el.find("a.img-link").click(function() {
            ...
            setTimeout(function() {
                ...
                //base = 450/300 = 1.5
                //img = 700 / 100 = 7 - should be width: 450
                //img = 480/200 = 2.4 should be width: 450
                //img = 200/800 = 0.26 should be height 
                
                var targetRatio = options.playerWidth/options.playerHeight;
                var wideRatio = $img.width()/$img.height() >= targetRatio ? true : false;
		...
		if(options.addThumbs) {
			...
			$el.children().each(function(i){
				...
				if ($link.hasClass('yt-vid')) {
    				...
    				var thumbHtml = "<img src='"+thumbUrl+"' alt='' />";
		...
		var firstVid = $("ul.demo2 li:first").addClass("currentvideo").children("a").click();
